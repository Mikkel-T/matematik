<script lang="ts">
  ...
  import { omitCalc, pmat } from "@math/calculation";

  function calculate() {
    let { P_1, P_2 } = calculator.opValues;
    answer.add(new Answer("\\vec{OP}", omitCalc(pmat(P_1, P_2))));
  }
</script>

<Calculator {calculate}>
  <Inputs inputs={[{ name: "P", type: "coord2d" }]} />
</Calculator>
