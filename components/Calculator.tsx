    ...
    <>
      <form onSubmit={onSubmit}>
        ...
        <div>
          <input
            type="submit"
            className="dark:bg-nord2 dark:hover:bg-nord3 dark:hover:border-nord2 dark:border-nord3 bg-nord5 border-nord4 hover:bg-nord4 hover:border-nord5 md:w-2/6 focus:outline-none w-3/4 p-2 mt-3 border-2 rounded-md cursor-pointer umami--click--calculate"
            value="Beregn"
          />
        </div>
      </form>
